...
public class NEXT1OR2OR3TAGRuleFactory extends AbstractRuleFactory {
	...
	public static final RuleFactory INSTANCE = new NEXT1OR2OR3TAGRuleFactory();
	...
	public Collection<Rule> create(Object from, Object to, Context context) {
		...
		return Arrays.<Rule> asList(
				NEXT1OR2OR3TAGRule.createRule(from, to, tag1), 
				NEXT1OR2OR3TAGRule.createRule(from, to, tag2),
				NEXT1OR2OR3TAGRule.createRule(from, to, tag3)
		);
	}
}